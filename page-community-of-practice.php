<?php 
    ...
    $page = get_page_by_title('Community Of Practice');
    ...
    <?php get_template_part("includes/sections/community-practice-sections/cta-section"); ?>
    <?php get_template_part("includes/sections/community-practice-sections/split-section-ii"); ?>
<?php 
    }
    get_footer()
?>