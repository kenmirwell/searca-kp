    ...
    <div>
                    ...
                    <?php while (have_rows('agpractices_platform')): the_row(); ?>
                        ...
                        ?>
                            <div class="flex items-center justify-between gap-[50px]">
                                <!-- Key Points Section -->
                                <div class="flex flex-col gap-[20px] items-start justify-between">
                                    <?php foreach ($key_points as $index => $point): ?>
                                        <div class="key-point cursor-pointer text-[#ffffff] rounded-xl w-[100%]" data-index="<?php echo $index; ?>">
                                            <div class="flex gap-[20px] items-start text-left w-[100%] p-[20px]">
                                                ...
                                                <div>
                                                    <h6 class="font-[600] text-[24px]"><?php echo $point['title']; ?></h6>
                                                    <p><?php echo $point['subtext']; ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    <?php endforeach; ?>
                                ...
                                <!-- Images Section -->
                                <div class="relative flex gap-[20px] items-center justify-between pt-[50px] w-[50%] h-[300px]">
                                    <?php foreach ($key_points as $index => $point): ?>
            ...
            <?php if (have_rows('agri_key_objectives')): ?>
                <?php while (have_rows('agri_key_objectives')): the_row(); ?>
                    <div class="text-center flex flex-col gap-[10px] pb-[50px]">
                        <h2 class="text-[36px] font-bold"><?php echo esc_html(get_sub_field('title')); ?></h2>
                            ...
                            <?php while (have_rows('key_points')): the_row(); ?>
                                <div class="flex items-start">
                                    <div class="flex flex-col gap-[10px] items-center text-center w-full max-w-[700px]">
                                        ...
                                        <h6 class="font-[600] text-[24px]"><?php echo esc_html(get_sub_field('title')); ?></h6>
                                        <p><?php echo wp_kses_post(get_sub_field('subtext')); ?></p>
                                    </div>
                                    <?php if ($index < 3): ?>
                                        <div class="mt-[50px]">
        ...
        <div class="w-[80%] sm:w-[640px] md:w-[768px] lg:w-[1024px] xl:w-[1280px] mx-auto py-[60px]">
            <div class="flex justify-between">
                <div class="w-[100%] text-left flex flex-col gap-[10px] pb-[20px] text-[#000000]">
        ...
        <div class="w-[80%] sm:w-[640px] md:w-[768px] lg:w-[1024px] xl:w-[1280px] mx-auto py-[60px]">
            <div class="flex justify-between items-center">
                <div class="flex flex-col gap-[20px]">
                    <h2 class="text-[36px] font-bold">Step-by-Step: How It Works</h2>
