...
<div class="hidden lg:block h-[370px] xl:h-[435px] rounded-[20px] group">
    <a href="<?php echo esc_url($page_link); ?>" class="flex items-end relative h-[100%] w-[250px] rounded-3xl overflow-hidden">
         <div class="p-[20px] z-[2]">
            ...
            <div id="comp-contianer-<?php echo get_the_ID(); ?>" class="pt-[10px] font-extralight text-[10px] xl:text-[14px] text-[#ffffff] overflow-hidden max-h-0 group-hover:max-h-[500px] transition-all duration-[1500ms] ease">
