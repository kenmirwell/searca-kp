...
<div class="component-item-element block w-[100%] md:w-auto h-[370px] xl:h-[435px] rounded-[20px] group component-<?php echo $components_index; ?>">
  <div class="flex items-end relative h-[100%] w-[100%] md:w-[250px] xl:w-[400px] rounded-3xl overflow-hidden">
    <div class="relative p-[20px] z-[2]">
      ...
      <!-- 🔁 Inner button-specific group -->
      <a class="block w-auto group cursor-pointer max-h-0 group-hover:max-h-[300px] overflow-hidden transition-all duration-300 ease-in-out delay-150" href="<?php echo esc_url($page_link); ?>">
        <div class="flex justify-between items-center gap-[20px] py-[5px] pl-[20px] pr-[5px] group-hover:bg-[#B59637] bg-[#096936] transition-all duration-200 ease rounded-full">
    ...
    <!-- 🔁 This image zooms when hovering the outer group -->
