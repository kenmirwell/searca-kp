...
<div class="component-item-element block w-[100%] md:w-auto h-[370px] xl:h-[435px] rounded-[20px] group component-<?php echo $components_index; ?>">
    <a href="<?php echo esc_url($page_link); ?>" class="flex items-end relative h-[100%] w-[100%] md:w-[250px] xl:w-[400px] rounded-3xl overflow-hidden">
         <div class="p-[20px] z-[2]">
            ...
            <div class="max-h-0 group-hover:max-h-[200px] overflow-hidden transition-all duration-300 ease-in-out delay-150">
                <?php
