...
<?php endif; ?>
    ...
    <?php endif; ?>
        ...
        <?php if($color == 'gold_to_green' ): ?>
            <div class="gold_to_green bg-[#096936] group-hover:bg-[#008c67] rounded-full p-[15px] transition-all duration-200 ease">
        <?php elseif($color == 'green_to_gold'): ?>
            <div class="green_to_gold bg-[#B59637] group-hover:bg-[#008c67] rounded-full p-[15px] transition-all duration-200 ease">
        <?php else: ?>
            <div class="green_to_white bg-[#008c67] group-hover:bg-[#008c67] rounded-full p-[15px] transition-all duration-200 ease">
        <?php endif; ?>
