<div class="relative ">
    <div onclick="handlePopup('home-filter-type', event)" class="flex gap-[20px] justify-between items-center text-[14px]  xl:text-[18px] font-[600] border-b-[1px] border-[#CECECE] py-[10px] cursor-pointer">
    ...
    <div id="home-filter-type" class="rounded-lg overflow-hidden">
        <?php
...
<div class="relative ">
    <div onclick="handlePopup('home-filter-author', event)" class="flex gap-[20px] justify-between items-center text-[14px]  xl:text-[18px] font-[600] border-b-[1px] border-[#CECECE] py-[10px] cursor-pointer">
        <p class="text-[16px]">Author</p>
        <svg width="22" height="8" viewBox="0 0 32 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M30 2L16 16L2 2" stroke="#000000" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
    </div>
    <div id="home-filter-author">
        <?php
            $terms = get_terms(array(
...
<div class="relative ">
    <div onclick="handlePopup('home-filter-country', event)" class="flex gap-[20px] justify-between items-center text-[14px]  xl:text-[18px] font-[600] border-b-[1px] border-[#CECECE] py-[10px] cursor-pointer">
        <p class="text-[16px]">Country</p>
        <svg width="22" height="8" viewBox="0 0 32 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M30 2L16 16L2 2" stroke="#000000" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
    </div>
    <div id="home-filter-country">
        <?php
            $terms = get_terms(array(
                'taxonomy' => 'country', 
                'hide_empty' => false,       
