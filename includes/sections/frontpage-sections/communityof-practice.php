                ...
                <?php while (have_rows('image_cards', $page_id)) : the_row(); ?>
                    ...
                    <div class="flex flex-col gap-[10px] w-[100%] text-left border-t-[1px] border-[#C2C2C2] pt-[50px]">
                        ...
                        <div class="text-left pt-[20px]">
                            <h6 class="font-bold text-display-24 text-[#1f1f1f] pb-[10px]"><?php echo esc_html(get_sub_field('image_card_title')); ?></h6>
                        ...
                        <div class="pt-[10px]">
                            <a class="flex items-center gap-[10px] text-display-16 font-semibold" href="">Learn More 
