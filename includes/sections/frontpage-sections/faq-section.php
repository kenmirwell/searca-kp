    ...
    <div class="w-[90%] lg:w-[1024px] xl:w-[1280px] mx-auto z-[1] relative">
        <div class="block md:flex gap-[20px] lg:gap-[80px]">
            <div class="flex flex-col gap-[20px] w-[100%] md:w-[50%]">
                ...
                <p  class="text-display-14 lg:text-display-18 text-[#ffffff]">Find answers to common questions about AFNR Knowledge Platform, and how we support sustainable agriculture in Southeast Asia.</p>
                <div class="flex">
                    <?php
