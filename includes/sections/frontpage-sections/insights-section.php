<div class="relative w-full rounded-t-3xl py-[80px] overflow-hidden">
  <div class="relative w-[90%] lg:w-[1024px] xl:w-[1280px] mx-auto z-[2]">
    <div>
      <div class="flex flex-col gap-[20px] w-[80%] lg:w-[1024px] xl:w-[1280px] mx-auto">
        <div class="flex justify-between">
          <div class="flex flex-col gap-[20px] w-[60%] text-white">
            ...
            <div class=" flex flex-col gap-[20px]">
                ...
                <p class="text-display-14 font-light">The 2026 State of Food Security and Nutrition in the World report shifts the global conversation from producing more food to making healthy diets affordable for everyone and the implications for ASEAN could not be more urgent.</p>
                <div class="flex gap-[20px]">
                  ...
                  <a class="flex gap-[20px] text-display-14 font-semibold" href="">View all Insights
                      <svg width="23" height="15" viewBox="0 0 23 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M14.5 14.3535L21.5 7.35352L14.5 0.353516M21.5 7.35352H0" stroke="white"/>
                      </svg>
                  </a>
