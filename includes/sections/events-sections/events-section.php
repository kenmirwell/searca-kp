                ...
                <?php if ($event->have_posts()) : ?>
                    <?php while ($event->have_posts()) : ?>
                        <?php
                            ...
                            $event_date = $event_schedule['event_date'];
                        ...
                        ?>
                            <div class="py-[20px] flex gap-[100px]">
                                <div class="flex w-[60%]">
                                    <div class="flex flex-col justify-start items-center px-[20px] pt-[20px] text-[#096936] bg-[linear-gradient(to_bottom,#ffffff_0%,#DCE9E2_100%)]">
                                        <p class="font-[200]"><?php echo $month ?></p>
                                        <p class="text-display-24 font-bold"><?php echo $day ?></p>
                                    </div>
                                    <div class="flex flex-col gap-[5px] border-l-[3px] border-l-[3px] border-[#096936] pl-[20px]">
                                        <div class="flex gap-[10px]">
                                            ...
                                            <div class="flex gap-[10px] text-display-16 text-[#096936]">
                                                <?php if ($event_schedule) : ?>
                                                    <p><?php echo esc_html($event_schedule['event_date']); ?></p>
                                        ...
                                        <h2 class="text-display-28 font-[500] text-[#1f1f1f]"><?php the_title(); ?></h2>
                                ...
                                <div class="w-[40%] image-container">
