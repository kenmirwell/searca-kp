...
<div class="py-[50px] lg:py-[100px]">
    <div class="w-[90%] lg:w-[1024px] xl:w-[1280px] mx-auto">
        <div class="relative flex flex-col items-center justify-center h-[300px] md:h-[500px] w-[100%] border-[1px] border">
            <div class="relative z-[3] flex flex-col md:pb-[50px] items-center justify-center w-[70%] mx-auto text-center">
        ...
        <?php if (have_rows('progressing_section')): ?>
            <div class="flex flex-col md:flex-row justify-between gap-[30px] progressing-section-items pt-[20px]">
                <?php $index = 0; ?>
                ...
                ?>
                    <div class="flex flex-col progressing-item" data-index="<?php echo $index; ?>">
                        <div class="w-[20%] md:w-full h-[4px] bg-gray-300 overflow-hidden mb-[10px]">
                            <div class="progress-bar h-full bg-[#096936]" style="width: 0%"></div>
                        </div>
                        <h6 class="text-[#1F1F1F] font-bold text-display-22"><?php echo esc_html($title); ?></h6>
                        <p class="text-[#1f1f1f] pb-[10px] text-display-14"><?php echo esc_html($description); ?></p>
                    </div>
                    <?php $index++; ?>
                <?php endwhile; ?>
            </div>
