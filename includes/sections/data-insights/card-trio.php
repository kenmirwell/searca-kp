        ...
        <div class="flex flex-col lg:flex-row gap-[50px] justify-between">
            <?php if (have_rows('image_cards', $page_id)) : ?>
                ...
                ?>
                    ...
                    <div class="relative flex flex-col gap-[10px] w-[100%] lg:w-[33.33%] text-left h-[100%] md:h-[320px] lg:h-[450px] rounded-xl overflow-hidden border-[1px] border-[#E3E3E3] shadow-xl">
                        <div class="relative flex flex-col justify-between z-[1] h-[100%] p-[30px]">
                          <div class="pb-[50px] md:pb-[0px]">
                          ...
                          <div class="text-left">
                              <h6 class="font-bold text-display-18 md:text-display-24 pb-[20px] <?php echo $image ? "text-[#ffffff]" : "text-[#1f1f1f]"?>"><?php echo esc_html(get_sub_field('image_card_title')); ?></h6>
                              <p class="text-display-14 md:text-display-16 <?php echo $image ? "text-[#ffffff]" : "text-[#1f1f1f]"?>"><?php echo esc_html(get_sub_field('image_card_description')); ?></p>
                          </div>
                        </div>
                        <?php if($image) : ?>
