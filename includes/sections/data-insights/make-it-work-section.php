<div class="py-[50px] lg:py-[100px] bg-[#096936]">
    <div class="w-[90%] lg:w-[1024px] xl:w-[1280px] mx-auto">
        <div class="text-[#ffffff] mb-[-50px]">
          <div class="font-bold w-[100%] md:w-[70%] flex items-center text-center mx-auto">
              <h2 class="w-[100%] text-display-24 lg:text-display-42 text-[#ffffff] pb-[10px]">Make It Work for You</h2>
          </div>
          <div class="w-[100%] md:w-[70%] flex items-center text-center mx-auto">
