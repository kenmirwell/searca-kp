<div class="w-[90%] lg:w-[1024px] xl:w-[1280px] mx-auto py-[80px]">
  <div class="flex flex-col md:flex-row justify-between gap-[10px] pb-[50px]">
    <h2 class="text-display-32 font-semibold">Knowledge Watch</h2>
    <div class="relative flex items-center md:w-[50%] justify-end">
      ...
      <div class="border-b-[1px] border-[#DADADA] w-[100%] md:w-[447px] knowledge-card" 
        ...
        <div class="flex flex-col gap-[20px] py-[20px]">
          ...
          <?php if ($display_title) : ?>
            <h6 class="text-display-18 font-semibold"><?php echo esc_html($display_title); ?></h6>
          <?php endif; ?>
