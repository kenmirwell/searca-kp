...
if (have_rows('split_section_iiv', $page_id)) : ?>
    <div class="relative">
        <?php while (have_rows('split_section_iiv', $page_id)) : the_row();
                    ...
                    <div class="">
                        ...
                        <?php if (!empty($button_group)) : ?>
                            <div class="flex gap-[10px] pt-[20px]">
                                <?php foreach ($button_group as $button_index => $button) : 
                                    ...
                                    <?php if (!empty($button_name)) : ?>
                                        <?php
                                            button_template('common-button', array(
                                                'title' => $button_name,
                                                'url'   => $button_url,
                                                'color' => $button_index === 0 ? 'green_to_white' : 'gold_to_white'
                                            ));
                                        ?>
                                    <?php endif; ?>
                                <?php endforeach; ?>
